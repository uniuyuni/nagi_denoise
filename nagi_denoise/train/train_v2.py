...
def main() -> None:
    ...
    criterion = NagiV2Loss(
        ...
        texture_stats_weight=float(loss_cfg.get("texture_stats_weight", 0.0)),
        texture_stats_sigmas=tuple(loss_cfg.get("texture_stats_sigmas", (1.2, 2.4))),
        texture_stats_pool=int(loss_cfg.get("texture_stats_pool", 16)),
        texture_stats_asymmetric=bool(loss_cfg.get("texture_stats_asymmetric", True)),
        texture_stats_eps=float(loss_cfg.get("texture_stats_eps", 1.0e-3)),
