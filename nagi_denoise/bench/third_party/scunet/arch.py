...
import numpy as np
# thop optional (only used in profile script in the original repo)
try:
...
try:
    from timm.layers import trunc_normal_, DropPath  # timm >= 0.9
except ImportError:
    from timm.models.layers import trunc_normal_, DropPath  # timm < 0.9
