...
# basicsr is not needed for inference; only the LayerNorm2d / weight init pieces are used.
def get_root_logger(*args, **kwargs):  # placeholder
    import logging
    return logging.getLogger("nafnet")
